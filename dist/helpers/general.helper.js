...
exports.getAbiByRelativePath = exports.sleep = exports.checkRanges = exports.checkPrivateKeysValidity = exports.shuffleArray = exports.getRandomDelay = exports.getRandomAmount = void 0;
var crypto_1 = require("crypto");
var decrypt_helper_1 = require("./decrypt.helper");
var fs = __importStar(require("fs"));
var path = __importStar(require("path"));
function getRandomAmount(web3, minEth, maxEth) {
    var amountEth = minEth + Math.random() * (maxEth - minEth);
...
function getRandomDelay(minDelay, maxDelay) {
    return (0, crypto_1.randomInt)(minDelay, maxDelay);
}
...
var checkPrivateKeysValidity = function (privateKeys, web3, password, isDecrypted) {
    return privateKeys.filter(function (key) {
        try {
            // дешифруем при необходимости
            var decryptKey = isDecrypted ? (0, decrypt_helper_1.decryptPrivateKey)(key, password) : key;
            return web3.eth.accounts.privateKeyToAccount(decryptKey);
        }
        catch (error) {
            console.error("Invalid private key: ".concat(key, ". Error: ").concat(error));
            return false;
        }
    });
};
